...
//			BlockingQueue cola=(BlockingQueue)entry.getValue();
//			 try {
//				p = (Paquete)cola.take();
//			} catch (InterruptedException e) {
//				// TODO Auto-generated catch block
...
//	 */
//	private BlockingQueue getCola(int iPrioridad) {
//		Integer key= new Integer(iPrioridad);
//		BlockingQueue cola= (BlockingQueue)mapColas.get(key);
